/*
 * ESP-01 WiFi ADC with RX and TX as GPIO pins
 * version 1.2.0 beta
 */
...
const int led0Pin = 0; // GPIO-0 of ESP-01
const int led1Pin = 1; // GPIO-1 of ESP-01
const int led2Pin = 2; // GPIO-2 of ESP-01
const int led3Pin = 3; // GPIO-3 of ESP-01
