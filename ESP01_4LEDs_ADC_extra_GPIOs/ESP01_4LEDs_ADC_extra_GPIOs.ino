/* 
 * ESP-01 WiFi ADC and extra GPIO pins
 * version 1.1.4 beta
 */
...
const int led0Pin = 4; // GPIO-04
const int led1Pin = 5; // GPIO-05
const int led2Pin = 12; // GPIO-12
const int led3Pin = 13; // GPIO-13
const int led4Pin = 14; // GPIO-14
//const int led5Pin = 15; // GPIO-15 Boot fails if pulled HIGH
