...
int setMinutes1 = 20;
int setMinutes2 = 40;
long pumpOperationTime = 45000; // set pump operation time in ms. Note: int datatype can only hold max value 32767.
...
void setup() {
  ...
  myRTC.setDS1302Time(30, 46, 20, 7, 03, 05, 2020); // uncomment line, upload to reset RTC and then comment, upload.
